...
#define STRING_CONFIG_H_AUTHOR "(kubik369 + xcloudx01)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 86.65
  #define DEFAULT_bedKi 16.92
  #define DEFAULT_bedKd 295.77
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 821.87 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39.90, -2.80, -1.90 }
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   6 // Z Clearance for Deploy/Stow of bltouch probe
...
#define PREHEAT_1_TEMP_HOTEND 209
