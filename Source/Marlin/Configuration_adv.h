...
#define BABYSTEPPING
  ...
  //#define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. *Doesn't work on Kingroon KP3S BLTouch, I can't get it to trigger - xcloudx01
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping. *To adjust babystep mid-print, go to Tune > Probe Z Offset and change the value. Change takes effect immediately upon confirming. Use this to get a perfect first layer.
